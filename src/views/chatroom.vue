<template>
  <!-- 聊天室 -->
  <div class="col-9 d-flex flex-column justify-content-between border border-2 rounded rounded-3 shadow-sm g-0">
    <div
      class="d-flex justify-content-between  align-items-center rounded-top-3 py-3 px-4 bg-light shadow-sm">
      ...
      <div class="row mb-3">
        ...
        <div class="col-auto">
          ...
          <div class="message-txt">
            <p class="p-1 other-txt d-inline-block">哈摟～律師您好</p>
    ...
    <div class="chatroom-input d-flex rounded-bottom-3 py-3 px-4 bg-light shadow-sm align-items-center">
      <input type="text" class="form-control rounded rounded-3 py-2 me-3" placeholder="輸入訊息">
      <button type="button" class="btn btn-dark send-btn rounded-pill">
                            <span class="material-icons align-middle">
                                send
                                </span>
      </button>
